...
var PhaseGroup = /** @class */ (function () {
    ...
    PhaseGroup.get = function (theId) {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        Logger_1.default.info('Getting Phase Group with id %s', theId);
                        return [4 /*yield*/, NetworkInterface_1.default.query(queries.phaseGroup, { id: theId })];
                    case 1:
                        data = _a.sent();
    ...
    PhaseGroup.prototype.getSeeds = function (options) {
        if (options === void 0) { options = Seed_1.Seed.getDefaultSeedOptions(); }
        return __awaiter(this, void 0, void 0, function () {
    ...
    PhaseGroup.prototype.getEntrants = function (options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var phaseGroupEntrantData, phaseGroups, entrants;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        phaseGroupEntrantData = _a.sent();
                        phaseGroups = phaseGroupEntrantData.map(function (groupData) { return groupData.phaseGroup; });
