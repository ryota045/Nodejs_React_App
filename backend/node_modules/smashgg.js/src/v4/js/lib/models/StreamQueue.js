...
var StreamQueue = /** @class */ (function () {
    ...
    StreamQueue.get = function (theTournamentId) {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        Logger_1.default.info('Getting Stream Queues for Tournament with Id %s', theTournamentId);
                        return [4 /*yield*/, NetworkInterface_1.default.query(queries.streamQueue, { tournamentId: theTournamentId })];
                    case 1:
                        data = _a.sent();
                        if (data.streamQueue)
                            return [2 /*return*/, StreamQueue.parseFull(data)];
                        else {
                            Logger_1.default.warn('Stream Queue for tournament %s is null', theTournamentId);
