            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.trys.push([1, 7, , 8]);
                        // parse options
                        options = Common_1.parseOptions(options);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        characters = _a.sent();
                        match = characters.filter(function (c) { return c.getId() === id; });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        characters = _a.sent();
                        characters = characters.filter(function (c) { return c.getVideoGameId() === id; });
                        if (!options.isCached) return [3 /*break*/, 6];
                        return [4 /*yield*/, Cache_1.default.getInstance().set(cacheKey, characters)];
                    case 5:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        else if (!videoGame.getId())
                            throw new Error('No game id found!');
                        return [4 /*yield*/, Character.getByGameId(videoGame.getId(), options)];
                    case 5:
                        character = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        characters = _a.sent();
                        match = characters.filter(function (c) { return c.getVideoGameId() === videogameId; });
                        character = match.length > 0 ? match[0] : undefined;
                        if (!options.isCached) return [3 /*break*/, 6];
                        return [4 /*yield*/, Cache_1.default.getInstance().set(cacheKey, character)];
                    case 5:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        videogame_1 = _a.sent();
                        match = characters.filter(function (c) { return c.getVideoGameId() === videogame_1.getId(); });
                        character = match.length > 0 ? match[0] : undefined;
                        return [4 /*yield*/, Cache_1.default.getInstance().set(cacheKey, character)];
                    case 6:
                        _a.sent();
