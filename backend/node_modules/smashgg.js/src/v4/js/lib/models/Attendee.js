...
var Attendee = /** @class */ (function () {
    ...
    Attendee.getDefaultAttendeeOptions = function () {
        return {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        phases = phaseData.map(function (phase) { return Phase_1.Phase.parse(phase); });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        groups = groupData.map(function (group) { return PhaseGroup_1.PhaseGroup.parse(group); });
